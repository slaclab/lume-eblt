...
class EBLTOutput(BaseModel):
    ...
    particle_distributions: Dict[int, ParticleDistributionOutput] = Field(default_factory=dict)
        ...
        for filename in os.listdir(directory):
            ...
            if match:
                ...
                if data.shape[1] == 3:  # CurrentProfileOutput has 3 columns
                    ...
                    particle_distributions[i] = ParticleDistributionOutput.load_from_file(filepath)
